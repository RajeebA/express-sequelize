...
- **Fork the repo**
- **Clone the repo** and set it up (check out the [manual installation](https://github.com/RajeebA/express-sequelize-private#manual-installation) section in README.md)
